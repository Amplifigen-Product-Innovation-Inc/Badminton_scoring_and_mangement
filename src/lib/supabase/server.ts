 ...
 * Uses the request's cookies for the authenticated session — still bound by RLS.
 * Do NOT use this for privileged operations; see `serviceRoleClient.ts` for that.
 */
